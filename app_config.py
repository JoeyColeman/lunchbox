...
PROJECT_SLUG = 'ThePublicRecord-ca-lunchbox'
...
GITHUB_USERNAME = 'joeycoleman'
REPOSITORY_URL = 'git@github.com:%s/%s.git' % (GITHUB_USERNAME, REPOSITORY_NAME)
REPOSITORY_ALT_URL = None # 'git@bitbucket.org:nprapps/%s.git' % REPOSITORY_NAME'

DEV_CONTACT = '@JoeyColeman'

"""
DEPLOYMENT
"""

FILE_SERVER_USER = 'lunchbox'
FILE_SERVER = 'lunchbox.thepublicrecord.ca'
FILE_SERVER_PATH = '/home/joeycoleman/webapps/tpr_lunchbox'
